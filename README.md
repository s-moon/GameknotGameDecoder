...
This tool will allow you to paste in Gameknot interactive scripts and convert them to [PGN](https://en.wikipedia.org/wiki/Portable_Game_Notation) format, quickly and easily.
